...
{ 
    public partial class Form1 : Form
    {
        ...
        private void verticalWavesToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            Filters filter = new vert_waves();
            backgroundWorker1.RunWorkerAsync(filter);
        }

        private void horisontalWavesToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
        ...
        private void horisontalWavesToolStripMenuItem_Click(object sender, EventArgs e)
        {
